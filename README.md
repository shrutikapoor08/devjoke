...
When my NON-IT FRIEND is with me: using 'mkdir new-filder', 'touch index.js' to make a new folder and file
and he looks at me and say that I am a hacker.

---

---

While my sister is beside me :
//python3
number = input()
convertedNumber = int(number)

also me when no one around me :
Ctrl C + Ctrl V
